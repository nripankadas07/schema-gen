        ...
        schema-gen exists to solve a narrow, inspectable developer-tooling problem:
        Generate Pydantic v2 models from JSON samples — automatic type inference, nested object support, and clean Python code generation
        ...
        Topics: code-generation, json-schema, pydantic, python, schema-generation
